...
class ReminderFrequencyController: UIViewController {
  ...
  private func updateUI() {
    ...
    // Label colors
    reminderFrequencyLabel.textColor = UIColor.custom.textPrimary
    soundLabel.textColor = UIColor.custom.textPrimary
    remindMeLabel.textColor = UIColor.custom.textPrimary
